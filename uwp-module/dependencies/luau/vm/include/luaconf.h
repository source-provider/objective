...
const uintptr_t nilObjectAddress = module::addresses::nilObject;
const uintptr_t dummyNodeAddress = module::addresses::dummyNode;
const uintptr_t luauExecuteAddress = module::addresses::luauExecute;
